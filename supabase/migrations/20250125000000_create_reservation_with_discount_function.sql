-- 예약 생성과 적립/쿠폰 차감을 트랜잭션으로 처리하는 함수 생성
-- Phase 4-6단계: 적립/쿠폰 시간 사용 로직 및 DB 차감 구현

BEGIN;

-- 예약 생성과 할인 적용을 트랜잭션으로 처리하는 함수
...
BEGIN
  ...
  INSERT INTO public.reservations (
    ...
    p_end_time,
    p_total_hours,
    p_final_price, -- final_price를 total_price에 저장
    p_final_price,
    p_total_price, -- 원래 가격을 original_total_price에 저장
    'confirmed',
    p_customer_name,
    p_company_name,
    p_shooting_purpose,
...
'예약 생성과 적립/쿠폰 차감을 트랜잭션으로 처리하는 함수. Phase 4-6단계에서 사용.';
