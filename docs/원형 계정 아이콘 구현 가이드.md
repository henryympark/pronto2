...
**작업 범위**:
- [ ] Git 브랜치 생성 (`feature/account-icon-header`)
- [ ] 필요 의존성 확인 및 설치
- [ ] 디렉토리 구조 생성 (`src/components/account/`)
- [ ] 상수 파일 생성 (`src/lib/constants/navigation.ts`)
...
- [ ] `AccountIcon` 컴포넌트 구현
  ...
  - 툴팁 기능 추가
- [ ] 반응형 크기 옵션 (sm/md/lg)
- [ ] 접근성 속성 추가 (aria-label, role, tabIndex)
